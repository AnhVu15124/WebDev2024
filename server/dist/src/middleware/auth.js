...
const user_role_model_1 = require("../database/models/user-role.model");
...
const authenticate = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    jsonwebtoken_1.default.verify(token, "access_token", (error, decoded) => {
        if (error) {
            res.sendStatus(403);
            return;
        }
...
const authorize = (permittedRoles) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        user_role_model_1.UserRole.findAll({ where: { userId }, include: role_model_1.Role }).then((data) => {
